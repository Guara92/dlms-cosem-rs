...
const CLOCK_CLASS_ID: u16 = 8;

/// Attribute ID for Clock.time
const CLOCK_TIME_ATTRIBUTE_ID: i8 = 2;

/// Class ID for ProfileGeneric object
const PROFILE_GENERIC_CLASS_ID: u16 = 7;
